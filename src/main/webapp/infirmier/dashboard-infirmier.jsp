                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <c:if test="${patient.enAttente}">
                                <a href="${pageContext.request.contextPath}/infirmier/affecter-patient?patientId=${patient.id}"
                                   class="text-teal-600 hover:text-teal-900 inline-flex items-center font-semibold">
                                    <svg class="h-5 w-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                              d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/>
                                    </svg>
                                    Affecter au généraliste
                                </a>
                            </c:if>
